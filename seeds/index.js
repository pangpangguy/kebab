...
const seedsdb = async () => {
  ...
  for (let i = 0; i < 50; i++) {
    ...
    const keb = new Kebab({
      ...
      description:
        "Nulla ut reprehenderit nostrud duis excepteur voluptate cupidatat officia ut sit quis irure id. Commodo cillum do ut dolore. Quis nulla commodo pariatur ipsum pariatur labore nisi Lorem sint reprehenderit aliquip exercitation. Veniam velit id nisi officia culpa commodo dolor aute minim.",
      price: randomNb(50),
